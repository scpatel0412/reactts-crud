...
const Login = () => {
    ...
    const HandleSubmit = (e:any) =>{
        ...
        if(data1.email === "" && data1.password ===""){
            ...
            axios.post(`http://localhost:8000/api/signin-user`,data1)
            .then((res:any) => {
                setRes1(res.data)
                ...
                if(res.data){
                    ...
                    history("/home",{state:{id:res.data.result._id,emailone:res.data.result.email}})
                }
    ...
    return (
        <div className='container-fluid' style={{background:"#DDDFDF"}}>
         <Row>
          ...
          <div style={{color:"red"}}>{error1.message}</div>
